...
[View the live project here](https://dar-tangier-73a241db6cbe.herokuapp.com/)
...
- Code, Django and API Integrations:
    ...
    - Fix ReservationForm bug: Followed some of the [Syscrews](https://syscrews.medium.com/context-processor-in-django-62818f14d88f) instructions to implement a context processor to fix ReservationForm loading issue. 
